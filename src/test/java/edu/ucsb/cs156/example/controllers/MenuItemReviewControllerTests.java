...
public class MenuItemReviewControllerTests extends ControllerTestCase {
  ...
  public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreviews/post?itemId=1&reviewerEmail=test@test.com&stars=5&dateReviewed=2022-01-03T00:00:00&comments=test comment")
                    .with(csrf()))
  ...
  public void admin_can_edit_an_existing_menuitemreview() throws Exception {
    ...
    when(menuItemReviewRepository.findById(eq(7L))).thenReturn(Optional.of(menuItemReviewOrig));

    // act
    MvcResult response =
        mockMvc
            .perform(
                put("/api/menuitemreviews?id=7")
