...
|-----------------------------|--------------|---------------|
| `UCSBDiningCommonsMenuItem` | Alex         | alexjh2       |
| `UCSBOrganization`          | Quinn        | quinnkos      |
| `RecommendationRequest`     | Saqif        | Saqif-Ayaan   |
| `MenuItemReview`            | William      | wpleee        |
| `HelpRequest`               | Omar         | omar882       |
| `Articles`                  | Mihir        | mihir-s-05    |
